...
# from olx_sdk.models import Offer as OlxOffer
# from pydantic import parse_obj_as
# from stonks_types.schemas import Offer, Fee, FeeCreate, StonksCreate, Device, PriceCreate, PricesCreate
#
# from config import olx, API_URL, config, allegro
#
